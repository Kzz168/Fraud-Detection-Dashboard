...
def visualize_results(df, G, suspicious_users):
    ...
    plt.hist(df[df['Is_Fraud'] == False]['Amount'], bins=20, alpha=0.5, label='Normal', color='blue')
    plt.hist(df[df['Is_Fraud'] == True]['Amount'], bins=20, alpha=0.5, label='Fraudulent', color='red')
